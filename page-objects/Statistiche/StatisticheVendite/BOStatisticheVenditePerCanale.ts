...
export default class BOStatisticheVenditePerCanale {
    page: Page;
    container: Locator;
    ...
    constructor(page: Page) {
        ...
        this.table = this.container.locator('div.stats-data-list');
        this.tableElements = this.table.locator('div.tree-node-content a:has(span.fa)');
        this.filterSection = this.container.locator('div.container.pms-scheduler-tools.stats-tools');
